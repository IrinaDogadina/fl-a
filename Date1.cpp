      ...
      switch (Curr_state) {
        ...
        case 2:
        {
            ...
            if(Day<32 && (int)Str[i]==47)
            {
              ...
              i=i+2;
              int temp=0;
              if(Month==1 || Month==3 || Month == 5 || Month == 7 || Month == 8|| Month==10|| Month==12){temp=1;}
              if(Month==2){temp=2;}
              if(Month==4 || Month==6 || Month ==9 || Month==11){temp=3;}
              switch (temp) {
                case 1:
                {
                  if(Day<32)
